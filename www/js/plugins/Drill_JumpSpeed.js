...
var _drill_JSp_isJumping = Game_CharacterBase.prototype.isJumping;
Game_CharacterBase.prototype.isJumping = function() {
    if (this._drill_JSp['enabled'] && this._drill_JSp['_data_inited']) {
        // 当启用自定义跳跃且正在跳跃时，返回 true
        return this._drill_JSp['_count'] < this._drill_JSp['time'];
    } else {
        // 否则，使用默认的跳跃判断逻辑
        return _drill_JSp_isJumping.call(this);
    }
};
