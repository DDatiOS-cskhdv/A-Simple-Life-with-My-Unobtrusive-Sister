...
(function() {
    ...
    Game_Interpreter.prototype.execPlayVoice = function(args, loop) {
        ...
        var channel  = args.length >= 5 ? getArgNumber(args[4], 1) : 1;
    ...
    Window_Options.prototype.addVolumeOptions = function() {
      ...
      /* 多语言适配 */
      let   label  = 'Voice Volume';   
      const sysText = window.systemFeatureText && window.systemFeatureText.voiceVolume;  
      if (sysText){
          label = window.systemFeatureText.voiceVolume;
        }				
        this.addCommand(label, 'voiceVolume');
    };
