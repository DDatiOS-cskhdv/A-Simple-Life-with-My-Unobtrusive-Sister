 ...
 * bubble_sp <character> ＠キャラ_play:穴から吹き出す泡
 ...
 * monster_sp <character> ＠キャラ:パーティクルが収束
 * monster_sp2 <character> ＠キャラ:集中線が発散。
...
$dataTrpParticleGroupsPreset = {
	...
	splash_cp:{"repeat":-1,"list":["play _auto:0 target","play _auto:1 target"],"targetType":0,"comment":
		"水しぶき"},
	monster_sp:{"repeat":-1,"list":["play _auto:0 target","play _auto:1 target"],"targetType":0,"comment":
		"モンスター召喚"},
	...
	//ナレーション  删除了"set _auto:0 target"
	warp_s:{"repeat":-1,"list":["set _auto:1 target"],"targetType":5,"comment":
		"ワープ風[画面演出]"},
...
$dataTrpParticlePreset = {
	...
	"_auto:0:monster_sp/h":[4,[[0,1,1,0]],[[0,3,0.1,1,1,0],0.8],[[0,1000,0.1,100,1,1],0.5],[[0,"#5b17ea",1,"#9daaff"]],0,[0,-30],null,[-215,45],[0,0],0,0,0,[0.4,0.6],1,0.01,1,2,0.1,10000,[0,0],0,[0,-12],null,0,0,"particle9",0,""],
	"_auto:1:monster_sp/h":[4,[[0,1,1,0]],[[0,3,1,0],0.2],[[0,500,1,1],0.5],[[0,"#000e32",1,"#8059ff"]],1,[0,0],null,[-90,-90],[0,0],0,0,0,[0.4,0.8],1,0.005,1,1,0.15,10000,[0,0],1,[0,0],[-24,-110,48,0],0,0,"line_oval3",0,""],
	...
	"_auto:1:warp_s/h":[4,[[0,0,0.5,1,1,0]],[[0,0,0.5,2,1,0],0.5],[[0,1600,1,200],1],[[0,"#467eff",1,"#ffffff"]],0,[0,0],null,[0,360],[0,0],0,0,0,[0.75,0.75],1,0.01,1,1,-1,10000,[0,0],0,[-480,-300],null,0,0,"line_oval3",5,""],
	...
	bubble_w:[[[0,0,0.2,0.6,0.95,0.6,1,0],0,0],[[0,0,0.2,0.3,0.95,0.7,1,0.8],0.4,0,0],[[0,1,0.2,50,1,50],0.5,0,0],[[0,"#ffffff",1,"#ffffff"],0,0],0,[0,0],0,[-90,-90],[0,0],0,0,[1,3],null,0.2,1,0,-1,10000,[0,0],1,[0,0],[-408,-312,816,624],null,0,0,"bubble1",6,
		"天候:水中の泡"],
	bubble_sp:[[[0,0,0.2,0.6,0.9,0.6,1,0],0,0],[[0,0,0.2,0.2,0.9,0.2,1,0.3],0.1,0,0],[[0,1,0.2,100,1,100],0.5,0,0],[[0,"#ffffff",1,"#ffffff"],0,0],0,[0,0],0,[-90,-90],[0,0],0,0,[1,3],null,0.05,1,0,1,10000,[0,0],1,[0,0],[-24,0,48,0],null,0,0,"bubble1",0,
		"キャラ_play:穴から吹き出す泡"],
	...
	light_orange_c:[4,[[0,0,0.5,0.4,1,0]],[[0,0.5,1,0.5],0.5],[[0,0,1,0],1],[[0,"#ff8c5b",1,"#ff8c5b"]],0,[0,0],null,[0,360],[0,0],0,0,0,[1,1],1,0.3,1,1,-1,10000,[0,0],0,[0,-12],null,0,0,"flare",0,
		"照明の光(オレンジ)"],
	jump_fuss_sp:[4,[[0,0,0.1,0.8,0.5,0.5,1,0]],[[0,0.3,0.9,0.3,1,0.1],0.5],[[0,150,0.2,50,1,0],0.5],[[0,"#ffffff",1,"#ffffff"]],0,[0,0],null,[-160,-20],[0,0],0,0,0,[0.3,0.6],0,0.01,1,2,0.1,60,[0,0],0,[0,0],null,0,0,"cartoon_fuss2",0,
		"ジャンプ時のアニメ調の煙"],
	...
	sparks_c:[[[0,1,0.5,1,1,0],0,0],[[0,0,0.5,0.3,1,0],0.5,0,0],[[0,1,1,1],0.5,0,0],[[0,"#ff5500",1,"#ff8d54"],0,0],0,[0,-100],0,[-90,-90],[0,0],0,2,[1,1],1,0.1,1,0,-1,10000,[0,0],1,[0,0],[-18,-36,36,24],null,0,0,"flame1",0,
		"キャラ:焚き火の火の粉"],
	trueSightEye:[[[0,1,0.5,1,1,0],0,0],[[0,0,0.8,0.45,1,0],0.5,0,0],[[0,1,1,1],0.5,0,0],[[0,"#ba0303",1,"#6c0b0b"],0,0],0,[0,-70],0,[-90,-90],[0,0],45,0,[1,1],1,0.25,1,0,-1,10000,[0,0],1,[0,0],[-18,-36,36,24],null,0,0,"trueSightEye",0,
		"キャラ:真视之眼"],				
	...
	darkness_s:[3,[[0,0,0.5,0.8,1,0]],[[0,8,0.5,8,1,8],0.5],[[0,1,1,1],1],[[0,"#000000",1,"#000000"]],0,[0,0],null,[0,360],[0,0],0,0,[2,2],2,0.04,1,1,-1,10000,[0,0],3,[0,0],[0,0,450,400],0,0,"smoke2,cloud2s",5,
		"スクリーン:暗闇の視界制限"],
	monster_sp:[3,[[0,0,0.1,1,0.9,1,1,0]],[[0,5,1,0.3],0.3],[[0,-220,1,-220],1],[[0,"#3714ff",1,"#0022ff"]],0,[0,0],null,[0,0],[0,0],0,0,[0.3,0.8],1,0.01,1,2,0.4,10000,[0,0],3,[0,0],[0,-24,100,80],0,0,"particle4",0,
		"キャラ:パーティクルが収束"],
	monster_sp2:[3,[[0,0,0.3,1,1,0]],[[0,2.5,0.3,1,1,0.5],0.8],[[0,1200,0.2,200,1,0],0.8],[[0,"#7b00ff",1,"#c99bff"]],1,[0,0],null,[0,360],[0,0],0,0,[0.4,0.8],1,0.01,1,3,0.1,10000,[0,0],0,[0,-24],null,0,0,"line_oval2",0,
		"キャラ:集中線が発散。"],
