 ...
 * @help
 * 【更新履歴】
 * 2.32 2022/03/29 グループエディタでエスケープ文字(\)対応(\V[1]など変数使用可)
...
var isMobileDevice = Utils.isMobileDevice && Utils.isMobileDevice();
...
(function () {
	...
	***************************************************************************** */
	...
	Game_Particle.prototype._remove = function (key, keys = this._keys, skipTruncateTagInfo = false) {
	...
	ParticleEmitter.prototype.updateForStartDash = function () {
		...
		var dashing = target.isDashing() && target.isMoved();
