...
Window_Base.prototype.drill_COWC_itemNameWithIcon = function( n ){
    var data = $dataItems[ n ];
	if( data == undefined ){ return ""; }
    return '\x1b{ \x1bI[' + data.iconIndex + ']\x1b}' + this.convertEscapeCharacters(data.name);
};
//==============================
// * 转义字符应用 - 图标+武器名（\IW[n]）
//==============================
Window_Base.prototype.drill_COWC_weaponNameWithIcon = function( n ){
    ...
    return '\x1b{ \x1bI[' + data.iconIndex + ']\x1b}' + this.convertEscapeCharacters(data.name) + nameSuffix;
};
//==============================
// * 转义字符应用 - 图标+护甲名（\IA[n]）
//==============================
